"""
Django settings for teste_42277 project.
...
WSGI_APPLICATION = 'teste_42277.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "teste_42277 API",
    "DESCRIPTION": "API documentation for teste_42277 App",
    "VERSION": "v1",
}
